...
from network_odes import main, no_observer, find_jac_sparsity, init_state_update_tuple
...
varying_gT = (False,)
state_update_tuple = init_state_update_tuple(num_neurs, num_int_gates, max_num_syns, num_estimators)
p = (Iapps,network,(α,γ),to_estimate,num_estimators,control_law,
     estimate_g_syns_g_els,observe_start_time,to_observe,varying_gT,state_update_tuple)
